...
class PodcasterProfile extends StatefulWidget {
  ...
  @override
  State<PodcasterProfile> createState() => _ResourcesState();
}

class _ResourcesState extends State<PodcasterProfile> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 8.0),
                      child: Text(
                        "Mood, Relationship, Self development, Career counsellor, Speech therapist",
                        style: TextStyle(
                            fontSize: 14,
