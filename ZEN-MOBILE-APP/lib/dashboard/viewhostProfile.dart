...
class ViewHostProfile extends StatefulWidget {
  final baseKey, hostDetails;
  ...
  @override
  State<ViewHostProfile> createState() => _ViewHostProfileState();
}

class _ViewHostProfileState extends State<ViewHostProfile>
    with SingleTickerProviderStateMixin<ViewHostProfile> {
  ...
  loadHost() async {
    return await Server().loadAHostProfile(
        appBloc: appBloc, context: context, userId: widget.hostDetails['_id']);
  }
